...
const LOCALES = {
  ...
  vi: {
    ...
    signature: "Chữ ký", signOut: "Đăng xuất", darkMode: "Chế độ tối", lightMode: "Chế độ sáng",
    // Message list
    ...
    archive: "Lưu trữ", reportSpam: "Báo cáo thư rác", delete: "Xóa", moveTo: "Di chuyển đến",
    star: "Gắn sao", unstar: "Bỏ sao", markRead: "Đánh dấu đã đọc", markUnread: "Đánh dấu chưa đọc",
    // Labels
    labels: "Nhãn", manageLabels: "Quản lý nhãn", newLabel: "Nhãn mới",
    labelName: "Tên nhãn", labelColor: "Màu sắc", noLabels: "Chưa có nhãn",
    addLabel: "Thêm nhãn", removeLabel: "Xóa nhãn", deleteLabel: "Xóa nhãn",
    deleteLabelConfirm: (n) => `Xóa nhãn "${n}"?`,
    filterLabeled: "Đã gắn nhãn",
    attachments: (n) => `Tệp đính kèm (${n})`,
    attachment: (n) => `${n} tệp đính kèm`,
    quickReplyPh: "Viết trả lời nhanh...",
    replyThreadPh: "Trả lời chuỗi...",
    ...
    replyTo: "Trả lời đến", blindCopy: "Bản sao ẩn",
    bcc: "Bcc tự động", orgLabel: "Tổ chức",
    useByDefault: "Sử dụng mặc định", enabled: "Bật",
    signatureSaved: "Đã lưu", signaturePlaceholder: "Tạo chữ ký của bạn...",
    enterUrl: "Nhập URL:",
    visualMode: "Trực quan", htmlMode: "HTML",
    uploadImage: "Chèn hình ảnh", signatureHtmlPlaceholder: "HTML chữ ký...",
    imageTooLarge: "Hình ảnh quá lớn. Kích thước tối đa là 2 MB.",
    enableSig: "Thêm chữ ký vào thư đi",
    invalidImageType: "Chỉ cho phép hình ảnh PNG, JPEG, GIF hoặc WEBP.",
    imageUploadFailed: "Tải hình ảnh thất bại. Vui lòng thử lại.",
    // Search
    searchPh: "Tìm kiếm...", searchMsgsPh: "Tìm kiếm thư...",
    // Calendar extra
    editEvent: "Sửa sự kiện", noTitle: "(Không có tiêu đề)",
    summary: "Tóm tắt", description: "Mô tả", location: "Địa điểm",
    removeRecipient: "Xóa người nhận",
    noSubject: "(Không có tiêu đề)",
    deleteFolder: "Xóa thư mục",
    deleteFolderConfirm: (name) => `Xóa thư mục "${name}"?`,
    // Compose extra
...
const I = {
  ...
  alignLeft: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="21" x2="3" y1="6" y2="6"/><line x1="15" x2="3" y1="12" y2="12"/><line x1="17" x2="3" y1="18" y2="18"/></svg>`,
  alignCenter:`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="21" x2="3" y1="6" y2="6"/><line x1="17" x2="7" y1="12" y2="12"/><line x1="19" x2="5" y1="18" y2="18"/></svg>`,
...
function renderSignatureModal() {
  ...
  if (S.sigMode === "visual") {
    ...
    toolbar.appendChild(toolbarBtn("underline", () => document.execCommand("underline")));
    toolbar.appendChild(h("div", { className: "w-px h-5 bg-slate-300 mx-1" }));
    toolbar.appendChild(toolbarBtn("alignLeft", () => document.execCommand("justifyLeft"), "Align left"));
    toolbar.appendChild(toolbarBtn("alignCenter", () => document.execCommand("justifyCenter"), "Align center"));
    toolbar.appendChild(h("div", { className: "w-px h-5 bg-slate-300 mx-1" }));
    toolbar.appendChild(toolbarBtn("link", () => {
      const url = prompt(t("enterUrl"));
